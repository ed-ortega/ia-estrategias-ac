...
REGLAS_FRIO["NL"]["SP"].extend([
    ...
    (_cond_and(lambda c: c['queja'] == "No", lambda c: c['estatus'] == "Ok",
               ...
               lambda c: _pct_cmp(c, '>', 45)), ("zt_sp", +1.0)),
    ...
    (_cond_and(lambda c: c['queja'] == "No", lambda c: c['estatus'] == "No enfria",
               lambda c: c['control_gse'] == 1, lambda c: c['tc'] > 0.5,
               lambda c: c['ti'] > 65, lambda c: c['cambios_sp'] < 8,
               lambda c: _pct_cmp(c, '>', 45)), ("zt_sp", +1.5)),
    (_cond_and(lambda c: c['queja'] is None, lambda c: c['estatus'] is None,
               lambda c: c['control_gse'] is None, lambda c: c['tc'] is None,
               lambda c: c['ti'] is None, lambda c: c['cambios_sp'] < 8,
               lambda c: _pct_cmp(c, '<', 45)), None),
...
REGLAS_FRIO["NL"]["SPD01"].extend([
    ...
    (_cond_and(lambda c: c['queja'] == "Si", lambda c: c['estatus'] == "No enfria",
               lambda c: c['control_gse'] == 1, lambda c: c['tc'] > 0.5,
               lambda c: c['ti'] > 65, lambda c: c['cambios_sp'] < 8,
               lambda c: _pct_cmp(c, '>', 35)), ("zt_spd01", +1.5)),
    (_cond_and(lambda c: c['queja'] == "No", lambda c: c['estatus'] == "No enfria",
               lambda c: c['control_gse'] == 1, lambda c: c['tc'] > 0.5,
               lambda c: c['ti'] > 65, lambda c: c['cambios_sp'] < 8,
               lambda c: _pct_cmp(c, '>', 20)), ("zt_spd01", +2.0)),
    (_cond_and(lambda c: c['queja'] is None, lambda c: c['estatus'] is None,
               lambda c: c['control_gse'] is None, lambda c: c['tc'] is None,
               lambda c: c['ti'] is None, lambda c: c['cambios_sp'] < 8,
               lambda c: _pct_cmp(c, 'range', (20, 35))), None),
...
REGLAS_FRIO["NL"]["SPD02"].extend([
    ...
    (_cond_and(lambda c: c['queja'] is None, lambda c: c['estatus'] is None,
               lambda c: c['control_gse'] is None, lambda c: c['tc'] is None,
               lambda c: c['ti'] is None, lambda c: c['cambios_sp'] < 8,
               lambda c: _pct_cmp(c, 'range', (30, 40))), None),
    (_cond_and(lambda c: c['queja'] is None, lambda c: c['estatus'] == "Ok",
               lambda c: c['control_gse'] == 1, lambda c: c['tc'] > 0.5,
               lambda c: c['ti'] <= 65, lambda c: c['cambios_sp'] < 8,
...
REGLAS_FRIO["Sureste"]["SP"].extend([
    ...
    (_cond_and(lambda c: c['queja'] == "No", lambda c: c['estatus'] == "Ok",
               lambda c: c['control_gse'] == 1, lambda c: c['tc'] > 0.5,
               lambda c: c['ti'] <= 65, lambda c: c['cambios_sp'] < 8,
               lambda c: _pct_cmp(c, '>', 60)), ("zt_sp", +0.5)),
    (_cond_and(lambda c: c['queja'] is None, lambda c: c['estatus'] is None,
               lambda c: c['control_gse'] is None, lambda c: c['tc'] is None,
               lambda c: c['ti'] is None, lambda c: c['cambios_sp'] < 8,
    ...
    (_cond_and(lambda c: c['queja'] is None, lambda c: c['estatus'] == "Ok",
               lambda c: c['control_gse'] == 1, lambda c: c['tc'] > 0.5,
               lambda c: c['ti'] <= 65, lambda c: c['cambios_sp'] < 8,
               lambda c: _pct_cmp(c, '<', 25)), ("zt_sp", -1.0)),
    (_cond_and(lambda c: c['queja'] == "Si", lambda c: c['estatus'] == "No enfria",
               lambda c: c['control_gse'] == 1, lambda c: c['tc'] > 0.5,
               lambda c: c['ti'] > 65, lambda c: c['cambios_sp'] < 8,
               lambda c: c['pct'] is None), None),
...
REGLAS_FRIO["Sureste"]["SPD01"].extend([
    ...
    (_cond_and(lambda c: c['queja'] is None, lambda c: c['estatus'] == "Ok",
               lambda c: c['control_gse'] == 1, lambda c: c['tc'] > 0.5,
               lambda c: c['ti'] <= 65, lambda c: c['cambios_sp'] < 8,
               lambda c: _pct_cmp(c, '<', 15)), ("zt_spd01", -0.5)),
    (_cond_and(lambda c: c['queja'] == "Si", lambda c: c['estatus'] == "No enfria",
               lambda c: c['control_gse'] == 1, lambda c: c['tc'] > 0.5,
               lambda c: c['ti'] > 65, lambda c: c['cambios_sp'] < 8,
...
REGLAS_FRIO["Sureste"]["SPD02"].extend([
    ...
    (_cond_and(lambda c: c['queja'] is None, lambda c: c['estatus'] is None,
               lambda c: c['control_gse'] is None, lambda c: c['tc'] is None,
               lambda c: c['ti'] is None, lambda c: c['cambios_sp'] < 8,
               lambda c: _pct_cmp(c, 'range', (35, 55))), None),
    (_cond_and(lambda c: c['queja'] is None, lambda c: c['estatus'] == "Ok",
               lambda c: c['control_gse'] == 1, lambda c: c['tc'] > 0.5,
               lambda c: c['ti'] <= 65, lambda c: c['cambios_sp'] < 8,
...
REGLAS_FRIO["BC"]["SP"].extend([
    ...
    (_cond_and(lambda c: c['queja'] == "No", lambda c: c['estatus'] == "Ok",
               lambda c: c['control_gse'] == 1, lambda c: c['tc'] > 0.5,
               lambda c: c['ti'] <= 65, lambda c: c['cambios_sp'] < 8,
               lambda c: _pct_cmp(c, '>', 35)), ("zt_sp", +1.0)),
    (_cond_and(lambda c: c['queja'] is None, lambda c: c['estatus'] is None,
               lambda c: c['control_gse'] is None, lambda c: c['tc'] is None,
               lambda c: c['ti'] is None, lambda c: c['cambios_sp'] < 8,
               lambda c: _pct_cmp(c, '<', 35)), None),
    (_cond_and(lambda c: c['queja'] is None, lambda c: c['estatus'] == "Ok",
               lambda c: c['control_gse'] == 1, lambda c: c['tc'] > 0.5,
               lambda c: c['ti'] <= 65, lambda c: c['cambios_sp'] < 8,
               lambda c: _pct_cmp(c, '<', 15)), ("zt_sp", -0.5)),
    ...
    (_cond_and(lambda c: c['queja'] == "No", lambda c: c['estatus'] == "No enfria",
               lambda c: c['control_gse'] == 1, lambda c: c['tc'] > 0.5,
               lambda c: c['ti'] > 65, lambda c: c['cambios_sp'] < 8,
               lambda c: _pct_cmp(c, '>', 35)), ("zt_sp", +1.5)),
    (_cond_and(lambda c: c['queja'] is None, lambda c: c['estatus'] is None,
               lambda c: c['control_gse'] is None, lambda c: c['tc'] is None,
               lambda c: c['ti'] is None, lambda c: c['cambios_sp'] < 8,
               lambda c: _pct_cmp(c, '<', 35)), None),
...
# FUNCIÓN PRINCIPAL
# =============================================================================
def clima_frio(data, alerta_ti, pct, queja, grupo, limite_alto, prediccion, resultado, resultclima):
    explicacion = []
